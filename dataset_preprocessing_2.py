...
header = ['file1_name', 'file2_name', 'notes1_path', 'notes2_path', 'image1_path', 'image2_path', "delta_position_meters"]

with open('data_pairs_position.csv', 'w', newline='') as f:
    writer = csv.writer(f)
    # write the header
    ...
    for file in files:
        ...
        if "notes" in file:
            ...
            for i in range(len(file_names_list)):
                ...
                text = [file_pair1, file_pair2, notes_pair1_path, notes_pair2_path, images_pair1_path, images_pair2_path, delta_position]
                with open('data_pairs_position.csv', 'a', newline='') as f:
                    writer = csv.writer(f)
