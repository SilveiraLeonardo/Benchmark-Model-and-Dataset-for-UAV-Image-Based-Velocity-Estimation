...
velocities = df["delta_position_meters"]
...
split = train_test_split(image_tuples, velocities, test_size = 0.20, random_state=42)
...
datasets = [
    ("train", trainPaths, trainLabels, "lists/train_google.csv"),
    ("val", valPaths, valLabels, "lists/val_google.csv"),
    ("test", testPaths, testLabels, "lists/test_google.csv")]
